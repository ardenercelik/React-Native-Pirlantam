          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.loginButtonContainerStyle}>
              <TouchableOpacity style={styles.loginButtonStyle} onPress={() => this.setState(state => ({ isLogin: !state.isLogin }))}>
                <Text style={styles.loginButtonTextStyle}> {this.state.isLogin ? "Yeni hesap oluştur" : "Giriş yap"}</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
    ...
    <SafeAreaView style={styles.containerStyle}>
      ...
      <View style={styles.formContainerStyle}>
        <TextInput
          ...
          error={isValid}
        />
        <TextInput label={"Password"} secureTextEntry autoCapitalize={false} style={styles.textInputStyle} selectionColor={blue} placeholder="Şifre" error={isValid} onChangeText={text => setPassword(text)} />
      </View>
      {error ? (
      ...
      <View style={styles.signInButtonContainerStyle}>
        <TouchableHighlight style={styles.signInButtonStyle} onPress={__doLogin} underlayColor={blue}>
          ...
          >
            <Text style={styles.signInButtonTextStyle}>Devam et</Text>
          </View>
        </TouchableHighlight>
      </View>
    </SafeAreaView>
...
const SigInComponent = () => {
  ...
  return (
    <SafeAreaView style={styles.containerStyle}>
      <View style={{ flex: 0.2 }}>{!!fetching && <ActivityIndicator color={blue} />}</View>
      <View style={styles.headerContainerStyle}>
        <Text style={styles.headerTitleStyle}> Kayıt Ol </Text>
      </View>
      <View style={styles.formContainerStyle}>
        <TextInput
          label={"Email"}
